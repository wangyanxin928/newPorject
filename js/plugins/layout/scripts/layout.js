...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            var startVal = $(this).parents().hasClass('start');
            var activeVal = $(this).parent().hasClass('active');
            ...
            if(startVal){
                ...
                $('li.nav-item').removeClass('start').removeClass('active');
                $(e.target).parents("li.nav-item").addClass("active");
                $('.arrow', $(this)).addClass("open");
            }

            $('.active >a >.arrow').addClass('open');
        ...
        $('.nav-toggle').click(function (e) {
            ...
            // $('.page-content-wrapper').fadeIn(1000);
            ...
            if(startVal){
                $('.start').removeClass('start');
                $(e.target).parent().parent().parent().parent().children().children().children('.arrow').addClass('open');
            }
        })
