                ...
                if (_routerTitle) {
                    ...
                    if(hrefString.indexOf('#')>0){
                        ...
                        if(routerTitle){
                            ...
                            $(".page-sidebar-menu li").removeClass("active");
                            $('.page-sidebar .page-sidebar-menu .start .start').removeClass('start');
                            $('.start').removeClass('start');
                            $(".page-sidebar-menu li a[href^='#" + routerTitle + "']").parent('li').addClass("active");
                            $(".page-sidebar-menu li a[href^='#" + routerTitle + "']").parent('li').parent('ul').parent('li').children('a').children('.arrow').addClass("open");
                            $(".page-sidebar-menu li a[href^='#" + routerTitle + "']").parents().addClass("active");
