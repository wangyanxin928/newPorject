...
define(function(require, module, exports) {
	...
	var tableTpl = require('text!plugins/DataTableView_new/datatable.xml');
	var pagingTpl = require('text!plugins/DataTableView_new/paging.xml');
	...
	var TableView = Backbone.View.extend({
		className:"search-page search-content-4",
...
//			});
	...
	var PagingView = Backbone.View.extend({
		className:"search-pagination pagination-rounded",
...
//						liArray.push("<li " + (index == i ? "class='pdi_paging_pageNumber_selected'" : "") + ">" + i + "</li>");
						liArrayNew.push("<li class='paginate_button "+(index==i?"page-active":"")+"' ><a href='javascript:;'>" + i + "</a></li>");
					}
...
//					liArray.push("<li>" + pageTotal + "</li>");
					...
					liArrayNew.push("<li class='paginate_button "+(index==pageTotal?"page-active":"")+"' ><a href='javascript:;'>" + pageTotal + "</a></li>");
				}
				// 第二种
				else if (index > pageMax - 3 && index <= pageTotal - 4) {
//					liArray.push("<li " + (index == 1 ? "class='pdi_paging_pageNumber_selected'" : "") + ">1</li>");
//					liArray.push("<li>" + moreSignal + "</li>");
					liArrayNew.push("<li  class='paginate_button "+(index==1?"page-active":"")+"'><a href='javascript:;'>1</a></li>");
					liArrayNew.push("<li  class='paginate_button '><a href='javascript:;'>" + moreSignal + "</a></li>");
...
//				ul.html("");
			...
			if(total!=0){
				...
				liArrayNew.unshift("<li class='"+(index==1?"disabled":"")+"' id='datatable_previous'><a href='javascript:;'>上一页</a></li>");
				liArrayNew.push("<li class='"+(index==pageTotal?"disabled":"")+"' id='datatable_next'><a href='javascript:;'>下一页</a></li>");
				...
				ulNew.find("li").on('click', function(li) {
					...
					if (value && value != moreSignal&&$(this).attr("id")!="datatable_previous"&&$(this).attr("id")!="datatable_next") {
						me.goPage(value);
					}
				});
			}else{
				this.$(".pagination").after('<div class="row" style="color: darkgrey;font-size: 30px;"> <i class="fa fa-search" style="font-size: 30px;"></i>没有数据</div>');
			}			
		}
	});
